 ...
 public void signup() throws Exception
 {
	 ...
	 try
	 {
		 if(driver.findElement(By.name(LoginP.nfname)).isDisplayed())
		 {
			...
			log.log(Status.PASS, "Create Acc Option is Working");
			File f=((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
			FileUtils.copyFile(f, new File(imgpath+"createacc.png"));
			log.addScreenCaptureFromPath(imgpath+"createacc.png");
	 ...
	 catch(Exception e)
	 {
			...
			log.log(Status.FAIL, "Create Acc Option NOT Working");
			File f=((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
			FileUtils.copyFile(f, new File(imgpath+"createacc.png"));
			log.addScreenCaptureFromPath(imgpath+"createacc.png");
	 }
